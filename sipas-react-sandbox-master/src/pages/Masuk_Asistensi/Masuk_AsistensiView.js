...
import './Masuk_AsistensiView.scss';

type Props = {
    routes: Array<{}>,
    dataMasukAsistensi: Array,
};

const Masuk_AsistensiView = ({routes, dataMasukAsistensi, t, ...props}: Props) => {
    const { url } = useRouteMatch();
    return(
        <Page name='masuk_asistensi' plain={true}>
            <List 
            itemLayout="vertical"
            dataSource={dataMasukAsistensi}
            renderItem={item=>(
...
export default withTranslation()(memo(Masuk_AsistensiView));