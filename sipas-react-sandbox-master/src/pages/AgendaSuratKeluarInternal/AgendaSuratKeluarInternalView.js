...
import './AgendaSuratKeluarInternalView.scss';
...
const data = [
		{
		  "jenis_surat": "Keluar Internal", 
		  "status": "Belum Terbaca", 
		  "nomor_surat": "102/MLG/08/2020", 
		  "from": "Manajemen PT Sekawan Media Informatika", 
		  "tanggal_terima": "hari ini", 
		  "type_surat": "UM Umum", 
		  "judul_surat": "Perayaan Hari Jadi PT Sekawan Media Informatika", 
		  "berkas": "-", 
		  "tembusan": "-", 
		  "id": 1, 
...
const AgendaSuratKeluarInternalView = ({
	loading,
	dataSource,
	rowKey,
	...
	return (
		<>
			<Helmet>
				<title>SIPAS | Agenda Surat Masuk</title>
			</Helmet>
			<Drawer
				title='Agenda Surat Keluar Internal Detail'
				width={800}
				onClose={closeDrawer}
...
export default AgendaSuratKeluarInternalView;
