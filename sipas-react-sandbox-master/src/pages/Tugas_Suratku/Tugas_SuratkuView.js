...
import './Tugas_SuratkuView.scss';

type Props = {
    routes: Array<{}>,
    dataTugasSuratku: Array,
};

const Tugas_SuratkuView = ({routes, dataTugasSuratku, t, ...props}: Props) => {
    const { url } = useRouteMatch();
    return(
        <Page name='tugas_suratku' plain={true}>
            <List 
            itemLayout="vertical"
            dataSource={dataTugasSuratku}
            renderItem={item=>(
...
export default withTranslation()(memo(Tugas_SuratkuView));