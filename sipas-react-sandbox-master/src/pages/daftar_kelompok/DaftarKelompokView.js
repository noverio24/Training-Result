...
import './DaftarKelompokView.scss';
...
const DaftarKelompokView = ({
	...
	return (
		<>
			<Helmet>
				<title>SIPAS | Daftar Kelompok Pegawai</title>
			</Helmet>
			<Drawer
...
export default DaftarKelompokView;
