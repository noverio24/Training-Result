...
import './Terkirim_SuratkuView.scss';
...
const Terkirim_SuratkuView = ({routes, dataTerkirim, t, ...props}: Props) => {
    const { url } = useRouteMatch();
    return(
        <Page name='terkirim_suratku' plain={true}>
            <List 
            itemLayout="vertical"
            dataSource={dataTerkirim}
            renderItem={item=>(
...
export default withTranslation()(memo(Terkirim_SuratkuView));