...
import './Terkirim_AsistensiView.scss';

type Props = {
    routes: Array<{}>,
    dataTerkirimAsistensi: Array,
};

const Terkirim_AsistensiView = ({routes, dataTerkirimAsistensi, t, ...props}: Props) => {
    const { url } = useRouteMatch();
    return(
        <Page name='terkirim_asistensi' plain={true}>
            <List 
            itemLayout="vertical"
            dataSource={dataTerkirimAsistensi}
            renderItem={item=>(
...
export default withTranslation()(memo(Terkirim_AsistensiView));