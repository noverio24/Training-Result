...
import './AgendaArsipBebasView.scss';
...
const AgendaArsipBebasView = ({
	...
	return (
		<>
			<Helmet>
				<title>SIPAS | Agenda Asrip Bebas</title>
			</Helmet>
			<Drawer
				title='Agenda Arsip Bebas Detail'
				width={800}
				onClose={closeDrawer}
...
export default AgendaArsipBebasView;
