...
const RegistrasiSuratMasukView = ({routes, dataTugas, t, ...props}: Props) => {
    let { path } = useRouteMatch();
	const { url } = useRouteMatch();
    return(
        <Page name='RegistrasiSuratMasuk' plain={true}>
...
RegistrasiSuratMasukView.defaultProps = {
	routes: [],
	dataTugas: [],
};

export default withTranslation()(memo(RegistrasiSuratMasukView));