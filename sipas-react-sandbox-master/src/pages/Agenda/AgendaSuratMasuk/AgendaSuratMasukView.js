...
import './AgendaSuratMasukView.scss';

type Props = {
    dataAgendaSuratMasuk: Array,
    routes: Array<{}>,
};

const AgendaSuratMasukView = ({routes, dataAgendaSuratMasuk, t, ...props}: Props) => {
    let { path } = useRouteMatch();
	const { url } = useRouteMatch();
    return(
        <Page name='AgendaSuratMasuk' plain={true}>
...
AgendaSuratMasukView.defaultProps = {
	routes: [],
	dataAgendaSuratMasuk: [],
};

export default withTranslation()(memo(AgendaSuratMasukView));