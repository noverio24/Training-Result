...
import './Tugas_AsistensiView.scss';

type Props = {
    routes: Array<{}>,
    dataTugasAsistensi: Array,
};

const Tugas_AsistensiView = ({routes, dataTugasAsistensi, t, ...props}: Props) => {
    const { url } = useRouteMatch();
    return(
        <Page name='tugas_asistensi' plain={true}>
            <List 
            itemLayout="vertical"
            dataSource={dataTugasAsistensi}
            renderItem={item=>(
...
export default withTranslation()(memo(Tugas_AsistensiView));