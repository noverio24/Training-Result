...
const asisten = [
	...
	{
		id: 2,
		avatar: 'https://expertphotography.com/wp-content/uploads/2018/10/cool-profile-pictures-aperture.jpg',
		daftar_pegawai: "Ningrum Tirampi",
		unit_kerja: "Divisi Humas DISPENDUK JEMBER",
...
class AsistenView extends React.Component {
  state = {
	current: 'mail',
	loading: false,
    visible: false,
  ...
  render() {
    ...
    return (
		<div>
			...
			>
				<Table tableLayout="auto" columns={columnAsisten} dataSource={asisten} onChange={onChange} />
				<Row>
					<Col span={8}>
						<div>
							Pegawai Terpilih
			  ...
			  <Table columns={columns} dataSource={asisten} onChange={onChange} />
