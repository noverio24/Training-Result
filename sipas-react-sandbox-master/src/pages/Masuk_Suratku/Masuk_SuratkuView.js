...
const Masuk_SuratkuView = ({routes, dataMasuk, t, ...props}: Props) => {
    const { url } = useRouteMatch();
    return(
        <Page name='masuk_suratku' plain={true}>
            <List 
            itemLayout="vertical"
...
export default withTranslation()(memo(Masuk_SuratkuView));